	...
	protected void doProcess(HttpServletRequest request, HttpServletResponse response)
		...
		switch (command) {
			...
			case "/QnaModifyAction.bo":
				...
				break;
			case "/QnaReplyView.bo":
				action = new QnaReplyView();
				break;
			case "/QnaReplyAction.bo":
