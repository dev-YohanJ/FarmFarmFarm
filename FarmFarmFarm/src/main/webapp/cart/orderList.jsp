...
<!-- Js Plugins -->
    <script src="js/cart/jquery-3.3.1.min.js"></script>
    <script src="js/cart/bootstrap.min.js"></script>
    <script src="js/cart/jquery.nice-select.min.js"></script>
    <script src="js/cart/jquery-ui.min.js"></script>
    <script src="js/cart/jquery.slicknav.js"></script>
    <script src="js/cart/mixitup.min.js"></script>
