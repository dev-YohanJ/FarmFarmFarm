		...
		<div class="row">
			...
			<div class="col-sm-8" style="margin-bottom: 5rem">
   	 		...
   	 		&nbsp;
												...
												<a href="QnaDetailAction.mgr?num=${q.qna_num }"> <c:if
							...
							<ul class="pagination justify-content-center">
								...
								<c:if test="${page > 1 }">
									<li class="page-item"><a
										href="QnaList.mgr?page=${page-1 }" class="page-link">이전&nbsp;</a>
									</li>
								</c:if>
								...
								<c:forEach var="a" begin="${startpage }" end="${endpage }">
									...
									<c:if test="${a != page }">
										<li class="page-item"><a href="QnaList.mgr?page=${a}"
								...
								<c:if test="${page < maxpage }">
									<li class="page-item"><a href="QnaList.mgr?page=${page+1 }"
...
<script>
	...
	for (var index = 0; index < filelist.length; index++) {
		if (pagefile == filelist[index]) {
			...
			$('.nav-pills > .nav-item > .nav-link').eq(index).removeClass(
					'active');
		}
	}
</script>
